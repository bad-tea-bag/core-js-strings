...
function sumOfCodes(str) {
  ...
  return letters.reduce((acc, letter) => acc + letter.charCodeAt(0), 0);
}
...
function isPalindrome(str) {
  const preparedStr = str.toLowerCase().replace(/[^a-z0-9]/g, '');
  const revercedStr = reverseString(preparedStr);
